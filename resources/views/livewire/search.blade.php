<div class="relative border border-white bg-black p-1 text-white">
    ...
    <input wire:model.debounce.500ms="search" type="text" placeholder="Titles, people, genres" class="ml-8 bg-black text-white placeholder-gray-500 focus:outline-none">
